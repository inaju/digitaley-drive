              ...
              <div className="mt-3 flex">
                <div className="flex">
                  <input
                    ...
                    name="remember-me"
                    type="checkbox"
                    className="shrink-0 mt-1.5 border border-gray-200 rounded text-blue-600 pointer-events-none focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
                  />
                </div>
                <div className="ml-3">
                  <label
