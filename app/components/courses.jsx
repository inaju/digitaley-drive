...
//   return (
//    <div className="border w-[100vw] bg-[#F2F8F1]">
//      <div
//       id="courses"
...
//           <div className="bg-[#14452f] h-[2px] w-32 mr-10"></div>
//         <h2 className="text-[18px] text-[#14452f] font- md:leading-tight dark:text-white">
//           Our Courses
//         </h2>
//         <div className="bg-[#14452f] h-[2px] w-32 ml-10"></div>
//         </div>
//         <h2 className="text-5xl mt-2 text-[#14452f] font-bold md:leading-tight dark:text-white">
//           Browse Our <span className="underline">Course</span> Catalog
//         </h2>
//         <p className="mt-4 text-[#14452f] dark:text-gray-400">
...
//         {/* Card */}
//         <a
//           className="group bg-white flex flex-col h-full border border-gray-200 hover:border-transparent hover:shadow-lg transition-all duration-300 rounded-xl  dark:border-gray-700 dark:hover:border-transparent dark:hover:shadow-black/[.4]"
...
//               </div>
//               <h3 className="text-2xl font-semibold text-[#14452f] dark:text-gray-300 dark:group-hover:text-white">
//                 Data Analytics
//               </h3>
