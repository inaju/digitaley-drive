    ...
    <div className={style}>
      <div className=" w-full relative h-full lato">
        ...
        <div className="relative shadow-xl bg-green-50 border border-greenPrimary  px-4 py-16 h-full overflow-hidden rounded-2xl flex flex-col justify- items-center">
         {/* <img src="https://cdn-icons-png.flaticon.com/128/2120/2120488.png" className="w-12 h-12"/>  */}
...
// https://cdn-icons-png.flaticon.com/128/2120/2120488.png
// https://cdn-icons-png.flaticon.com/128/694/694900.png