        ...
        <div className="lg:grid flex flex-col lg:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col bg-white rounded-xl dark:bg-slate-900">
              <div className="flex-auto p-4 md:p-6">
                <p className="text-base italic md:text-lg text-gray-800 dark:text-gray-200">
                  My name is Karabo Bhulose, I live in KZN,South Africa. My
                  experience with Digitaleydrive was amazing as the classes were
                  very informative. My highlights was learning how to analyze
                  data with excel. I previously found it difficult, however on
                  joining Digitaleydrive, one of the facilitators made it easier
                  for me and that has had a huge impact on my skill set and life
                  generally. As a final year student in Business Information
                  with the Durban University of technology, I will say that I am
                  more efficient in practical things I do with the help of
                  Digitaleydrive data training.
                </p>
              </div>
          ...
          <div className="flex h-auto">
            <div className="flex flex-col bg-white rounded-xl dark:bg-slate-900">
              <div className="flex-auto p-4 md:p-6">
                <p className="text-base italic md:text-lg text-gray-800 dark:text-gray-200">
                  The Python Programming class by Digitaleydrive so far has been
                  absolutely amazing, the instructors possess a deep
                  understanding of Python programming. Their clear explanations
                  and real-world examples made complex concepts accessible, even
                  for beginners like me. Classes have been highly engaging, with
                  a good balance of theory and hands-on coding exercises. They
                  also fostered a collaborative learning environment,
                  encouraging questions and discussions that enhanced our
                  understanding of Python. Thank you Digitaleydrive for this
          ...
          <div className="flex h-auto">
            <div className="flex flex-col bg-white rounded-xl dark:bg-slate-900">
              <div className="flex-auto p-4 md:p-6">
                <p className="text-base italic md:text-lg text-gray-800 dark:text-gray-200">
                  As someone transitioning from Pharmacy to Data analysis, I
                  wasn&apos;t sure what to expect. However, the learning process
                  was comprehensive, with a well-structured curriculum that made
                  it easy to progress from the basics to advanced aspects. The
                  instructors were very supportive and patient, providing clear
                  explanations for tasks and areas we found difficult. My
                  highlight during the training was the opportunity to work on
                  projects that mirrored real-life data scenarios. These
                  projects challenged me to learn new concepts every day,
                  pushing me to do more research outside the covered material.
                  Receiving constructive feedback from the tutors further helped
                  me improve my skills. After the training, I feel more
                  confident and well-equipped to work independently on projects
                  and pursue a career in data analysis. I&apos;m excited about
                  the prospect of implementing my skills in a professional
                  setting.
                </p>
              </div>
              <div className="p-4 bg-gray-100 rounded-b-xl md:px-7 dark:bg-slate-700">
