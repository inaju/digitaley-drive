...
// export const Todo = ({ id, img }: CardProps) => {
//   return (
//     <FeatureCard id={id} gradient="from-[#f7f0ff] to-[#a78afe]" url="">
//       <span />
//     </FeatureCard>
//   );
// };
...
//   return (
//     <FeatureCard id={id} gradient="from-[#f5fbff] to-[#addeff]" url="">
//       <span />
//     </FeatureCard>
//   );
// };
...
//   return (
//     <FeatureCard id={id} gradient="from-[#f5fff7] to-[#adf8ff]" url="">
//       <span />
//     </FeatureCard>
//   );
// };
...
//   return (
//     <FeatureCard id={id} gradient="from-[#f7fff5] to-[#adffd8]" url="">
//       <img
//         className={classNames(
...
// <img src="https://images.unsplash.com/photo-1608222351212-18fe0ec7b13b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8ZGF0YSUyMGFuYWx5dGljc3xlbnwwfHwwfHx8MA%3D%3D" className="h-[100%] w-[100%] absolute top-0 left-0"/>
//     </FeatureCard>
//   );
// };
...
//   return (
//     <FeatureCard id={id} gradient="from-[#fff7f5] to-[#ffd8ad]" url="https://images.unsplash.com/photo-1560472354-b33ff0c44a43?q=80&w=2151&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D">
//       <img src="https://images.unsplash.com/photo-1560472354-b33ff0c44a43?q=80&w=2151&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
...
//   return (
//     <FeatureCard id={id} gradient="from-[#fef5ff] to-[#ffade1]" url="">
//       <span />
//     </FeatureCard>
//   );
// };
