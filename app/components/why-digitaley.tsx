...
const reasons = [
  ...
  },
  {
    ...
    description:
      "We have an array of valuable and affordable classes for students who want to dip their feet into the world of tech",
...
const WhyDigitaley = (props: Props) => {
  return (
    ...
    >
      <h1 className="text-3xl text-center">Why Digitaley <span className="border-b-4 text-greenPrimary border-greenPrimary pb-1">Drive</span></h1>
