    ...
    >
      ...
      <div className="flex gap-20 mt-16">
        <div className="w-6/12">
          ...
          <p className="text-[16px] mt-1 text-gray-500">Be a part of the conversation with other writers. Ask and answer questions on your favorite topics. Collaborate and explore different forums.</p>
