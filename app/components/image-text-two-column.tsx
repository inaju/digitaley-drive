      ...
      <div className="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
        ...
        >
          <div className="">
            <div className="">
              <img
                src="https://images.unsplash.com/photo-1599658880436-c61792e70672?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8ZGF0YSUyMGFuYWx5c3R8ZW58MHx8MHx8fDA%3D"
                className="w-[100%] lg:w-9/12 rounded-xl h-auo shadow-md"
              />
              <img
                src="https://images.unsplash.com/photo-1523289333742-be1143f6b766?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8bGVhcm5pbmclMjBtYW5hZ2VtZW50JTIwc3lzdGVtfGVufDB8fDB8fHww"
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="space-y-2 md:space-y-4">
                ...
                <p className="text-gray-500">
                  ...
                  changer – with us you can start a digital job after just 3
                  months of training. Do it like over 2,000 other graduates and
