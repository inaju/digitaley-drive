                    ...
                    >
                        ...
                        <div className="flex lg:grid grid-cols-2 flex-wrap justify-center gap-4">
                            {aboutFeaturs.map((feature) => (
                                <div
                                    key={feature.title}
                                    className="group flex flex-col basis-[240px] flex-grow border border-solid border-gray-300 hover:border-black rounded-3xl p-4 text-start hover:bg-gray-10 transition-colors duration-300"
                                >
