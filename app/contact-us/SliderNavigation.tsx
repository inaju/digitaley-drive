...
// // const SliderNavigation = forwardRef((_, ref, length) => {
// //     return (
...
// //     const handleManualNavigation = (navigate) => {
...
// //                 type="button"
// //                 className="group btn btn-outline flex items-center justify-center gap-x-2 w-14 sm:w-fit px-0 sm:px-6"
// //                 onClick={() => handleManualNavigation(() => ref.current.swiper.slidePrev())}
// //             >
// //                 <svg
// //                     width="71"
// //                     height="51"
...
// //                 type="button"
// //                 className="group btn btn-outline flex items-center justify-center gap-x-2 w-14 sm:w-fit px-0 sm:px-6"
// //                 onClick={() => handleManualNavigation(() => ref.current.swiper.slideNext())}
// //             >
// //                 <p className="hidden sm:block">Next</p>
// //                 <svg
// //                     width="71"
...
// const SliderNavigation = forwardRef(({ length }: { length: any }, ref) => {
//     const [direction, setDirection] = useState("forward");
//     const [isAutoSliding, setIsAutoSliding] = useState(true);
//     // const intervalRef = useRef(null);
...
//     //         intervalRef.current = setInterval(() => {
//     //             if (direction === "forward") {
//     //                 if (ref && 'current' in ref && ref.current) { // Add null check here
...
//         if (isAutoSliding) {
//           intervalRef.current = setInterval(() => {
//             // Check if ref is a MutableRefObject and ref.current is not null
